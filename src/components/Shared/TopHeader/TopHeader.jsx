        ...
        <div id="topbar" className="d-flex align-items-center fixed-top">
            <div className="container d-flex justify-content-between">
                <div className="contact-info d-flex align-items-center">
                    <FaEnvelope className='contact-icon'/> <a href="mailto:ayushkumar.12212147@lpu.in">ayushkumar.12212147@lpu.in</a>
                    <FaPhoneAlt className='contact-icon'/> <a href="tel:9555040155">9555040155</a> 
                </div>
