						...
						<div className="profile-widget">
							...
							<div className="pro-content">
								...
								<ul className="available-info">
									<li>
										<FaLocationArrow className='icon' /> Phagwara , Punjab
									</li>
									<li>
										<FaClock className='icon' /> Available on Fri, 22 Mar
									</li>
									<li>
										<FaDollarSign className='icon' /> Rs 100 - Rs 400 per hour
									</li>
								</ul>
				...
				<div className="row">
					<div className="col-12 col-md-3 col-lg-3">
						<div className='mb-2 section-title text-center'>
							...
							<p className='m-0 text-secondary'>We stand by your side in tough times.</p>
						</div>
						<div className="form-text">
							<p>After booking your appointment, you'll be connected with our team of experienced doctors who specialize in addressing your specific medical needs</p>
							<p>Rest assured, you'll receive personalized care and attention from our dedicated healthcare professionals, ensuring your well-being is our top priority.</p>
