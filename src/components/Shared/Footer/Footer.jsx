						...
						<div className="col-6 col-md-6 col-lg-3">
							<div className="footer-widget footer-about">
								...
								<div className="footer-about-content">
									<p className='form-text' style={{maxWidth:200}}>A hospital is a place where people go to receive medical treatment and care. It's staffed by doctors, nurses, and other healthcare professionals who work together to help patients recover from illness or injury.</p>
								</div>
							</div>
						</div>
							...
							<div className="footer-widget footer-contact">
								...
								<div className="footer-contact-info">
									<div className="footer-address">
										...
										<p> Uni Hospital<br /> Lovely Professional University </p>
									</div>
									<p>
