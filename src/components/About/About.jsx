...
import img from '../../images/Achivement.jpg'
...
const About = () => {
    ...
    return (
        <>
            <Header />
            <SubHeader title="about us" subtitle="We thrive for excellence and achieve it." />
            <div className="container" style={{ marginBottom: 100, marginTop: 100 }}>
                <div className="row p-5">
                    <div className="col-lg-4">
                        <div className='section-title text-center'>
                            <h2 className='text-uppercase'>Our Doctors Acheivement</h2>
                            <p className='form-text m-0'>Celebrating the Remarkable Achievements of Our Esteemed Doctors</p>
                        </div>
                        <p className='mt-3'>With a commitment to excellence in healthcare, our doctors have garnered recognition and accolades for their contributions to the field. From groundbreaking research publications to prestigious awards and certifications, our doctors' achievements reflect their dedication to providing high-quality care and advancing medical knowledge. We take pride in showcasing their achievements as a testament to their expertise and unwavering commitment to patient well-being.</p>
                    </div>
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-6">
                        <div className='mb-4 section-title text-center'>
                            ...
                            <p className='form-text m-0'>They Give their best to help you always</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-lg-6 offset-lg-6">
                        <div className='mb-4 section-title text-center'>
                            ...
                            <p className='form-text m-0'>They convert opportunity into happiness</p>
                        </div>
                    </div>
                </div>
